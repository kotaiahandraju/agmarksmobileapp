                    ...
                    try {
                        ...
                        dataList=new ArrayList<HashMap<String, String>>();
                            if (jsonarray.length()>0) {
                                ...
                                HistoryAdapterF adapter = new HistoryAdapterF(getActivity(), productList, dataList);
                ...
                public void onResponse(JSONObject response) {
                    ...
                    try {
                        ...
                        if (jsonarray.length()>0) {
                            ...
                            HistoryAdapterF1 adapter1 = new HistoryAdapterF1(getActivity(), productList, dataList);
                ...
                public void onResponse(JSONObject response) {
                    ...
                    try {
                        ...
                        //if (jsonarrayi.length()>0 && jsonarray.length()>0) {
                            ...
                            HistoryAdapterF2 adapter1 = new HistoryAdapterF2(getActivity(), productList, dataList, tokenid);
